...
def train_yolo_segmentation(dataset_path: str, epochs: int = 100):
    """Trains YOLO model for segmentation"""
    # Load pre-trained YOLOv8 model for segmentation
    ...
    results = model.train(
        ...
        name='digits_segment-12_with_real_digits',  # experiment name
...
def main():
    # Path to dataset
    dataset = "/home/optimus/Desktop/Work/EasyData/Hand-Written-Digits-Detection/Yolo/Dataset-v12-seg"
    
    # Train the model
    print("Starting model training...")
    results = train_yolo_segmentation(dataset, epochs=100)
